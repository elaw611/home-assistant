...
from homeassistant.components.climate.const import (
    STATE_AUTO, STATE_COOL, STATE_FAN_ONLY, STATE_HEAT)
from homeassistant.const import (
    ...
    SERVICE_LOCK, SERVICE_UNLOCK, STATE_CLOSED, STATE_CLOSING, STATE_IDLE,
    STATE_LOCKED, STATE_OFF, STATE_ON, STATE_OPEN, STATE_OPENING,
    STATE_PROBLEM, STATE_UNKNOWN, STATE_UNLOCKED, TEMP_CELSIUS,
    TEMP_FAHRENHEIT, UNIT_UV_INDEX, VOLUME_GALLONS, VOLUME_LITERS)
